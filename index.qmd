...
![](figures/publications/covid_infectious-diseases.png){.absolute top=100 left=200 width="500" style="box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);"}

. . .

![](figures/publications/alcoholism_nature.png){.absolute top=150 left=270 width="500" style="box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);"}

. . .

![](figures/publications/terrestrial-nature_pnas.png){.absolute top=200 left=340 width="500" style="box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);"}

. . .

![](figures/publications/coffee_nature.png){.absolute top=250 left=410 width="500" style="box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);"}

. . .

![](figures/publications/tumors_neuro-oncology.png){.absolute top=300 left=480 width="500" style="box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);"}

. . .

![](figures/publications/gut-microbiota_cell.png){.absolute top=350 left=550 width="500" style="box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);"}
...
> _The tidymodels framework is a collection of packages for modeling and machine learning using tidyverse principles._
> <p style="text-align:right;">\- tidymodels.org</p>
...
> _The tidymodels framework is a collection of packages for safe, performant, and expressive supervised predictive modeling on tabular data._
