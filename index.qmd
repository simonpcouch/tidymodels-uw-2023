...
![](figures/institutions/ubc.png){.absolute top=90 left=50 width="80"}
![](figures/institutions/utoronto.png){.absolute top=90 left=120 width="80"}
...
> _The tidymodels framework is a collection of packages for safe, performant, and expressive <span style="color:#CA225E">supervised predictive modeling</span> on tabular data._
...
> _The tidymodels framework is a collection of packages for safe, performant, and expressive supervised predictive modeling on <span style="color:#CA225E">tabular data</span>._
...
> _The tidymodels framework is a collection of packages for <span style="color:#CA225E">safe, performant, and expressive</span> supervised predictive modeling on tabular data._
